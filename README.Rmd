...
library(here)
knitr::include_graphics(here("Leaf_image", "img1.png"))
```



```{r, echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics(here("Leaf_image", "lf_sh.png"))
```

```{r, echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics(here("Leaf_image", "mr.png"))
```

```{r, echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics(here("Leaf_image", "simple_leaf_parts.png"))
```
...
## Leaf images of medicinal plants in Sri Lanka
